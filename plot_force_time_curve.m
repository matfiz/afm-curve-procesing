function plot_force_time_curve(hObject,handles)
%read params
...
if (~isempty(relaxationPanel) && ~isempty(curve.dataSeriesTime))
    ...
    title(relaxationHandles.axes_force_time, ['Force-time for curve ' handles.current_curve.name],'interpreter','none');
